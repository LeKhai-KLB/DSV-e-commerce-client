...
function AdminProductInfo() {
    ...
    return (
        <form className={styles.productInfoContainer} onSubmit={(e) => handleSubmit(e)} >
            ...
            {
                showAddCategoryBox &&
                <AddCategoryModal handleShowBox={setShowAddCategoryBox} admin={admin} setValue={setCategoryAdded}/>
            }
                ...
                <div className={styles.quantityBoxContainer}>
                    {
                        sizeList && sizeList.map((r, i) => 
                            <div key={i} className={styles.quantityBox}>
                                <span className={styles.label + ' ' + styles.mr8}>
                                    {r}
                                </span>
                                <input 
                                    value={quantity[r]}
            ...
            {/* color */}
            <SelectBox required={true} title="colors" addMore={false} onChange={setColorList} handleLoad={handleLoadColors} initData={initData.colors} />
