      ...
      if (!user) {
        ...
        try {
          ...
          const { data } = await axios.post(
            process.env.REACT_APP_ADD_ORDER_API,
            {
              customer: user.id,
              cart: [...cart],
            },
          ...
          if (data.status === 200) {
            ...
            socket.emit("checkout", timpStamp);
          } else {
                ...
                <div key={i} className={styles.entry}>
                  ...
                  <div className={styles.productField}>
                    ...
                    <div className={styles.productTextBox}>
                      <div className={styles.productTitle}>{e.productName}</div>
                  ...
                  <div
                    ...
                    style={{ backgroundColor: e.color.value }}
                  />
                  ...
                  <div className={styles.quantityField}>
                    <img
                      ...
                      onClick={() => {
                        ...
                        if (input.value > 1) dispatch(decreaseQuantity(i));
                      }}
                    />
                    <input
                      id={"input" + i}
                  ...
                  {/* amount field */}
                  <span className={styles.amountField}>${e.amount}.00</span>
                </div>
              ))
            ) : (
