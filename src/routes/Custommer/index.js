...
// component
import NavBar from '../../components/Custommer/NavBar'
import Footer from '../../components/Custommer/Footer'
import RegisterBox from '../../components/Custommer/RegisterBox'
import LoginBox from '../../components/Custommer/LoginBox'
import ForgotPasswordBox from '../../components/Custommer/ForgotPasswordBox'

export const requiredAuthContext = createContext(null)

function CustommerRoute() {
...
export default memo(CustommerRoute)